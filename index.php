...
<body>
  ...
  <header>
    <nav role='navigation'>
      <ul>
        <li><a class="btn-type" href="php/display-movies-alphabet.php">Films</a></li>
        <li><a class="btn-type" href="php/display-tvshows-alphabet.php">Séries</a></li>
        <li><a class="btn-type" href="php/display-animes-alphabet.php">Animes</a></li>
        <li id="icon-trigger" class="icon icon-trigger"><a class="btn-icon" href="">
        ...
        <li><a class="btn-type" href="php/display-animation-alphabet.php">Dessins animés</a></li>
        <li><a class="btn-type" href="php/display-spectacles-alphabet.php">Spectacles</a></li>
      </ul>
    </nav>
  ...
  <main class="main">
    ...
    <div class="mainBottom">
      ...
      <?php
      // Appel de la fonction de sélection aléatoire de 6 films par leur poster
      $result = select_six_random_movie();
      ...
      foreach ($result as $row) {
        echo '<td><a href="php/viewpage.php?id=' . $row['idMovie'] . '"><img src="src/thumbnails/' . $row['cachedurl'] . '" title="' . $row['c00'] . '" alt="' . $row['c00'] . '" height="288" width="192"/></a></td>';
      }
      echo "</tr>";
      echo "</table>";
      ?>
