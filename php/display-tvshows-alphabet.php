...
<body>
  ...
  <header>
    <nav role='navigation'>
      <ul>
        <li><a class="btn-type" href="tvshows/display-results-genre.php?id=6">Science-Fiction</a></li>
        <li><a class="btn-type" href="tvshows/display-results-genre.php?id=14">Thriller</a></li>
        ...
        <li><a class="btn-type" href="tvshows/display-results-genre.php?id=26">Horreur</a></li>
        <li><a class="btn-type" href="tvshows/display-results-genre.php?id=1">Animation</a></li>
      </ul>
    </nav>
  ...
  <main class="mainAlphabet">
    ...
    <div class="mainAlphabetTop">
      <h1 class="hType">Séries</h1>
      <ul class="alphabet">
        <li><a href="tvshows/display-results-numbers.php" class="letters"><span class="&">&</span></a></li>
        <li><a href="tvshows/display-results.php?id=a" class="letters"><span class="A">A</span></a></li>
        <li><a href="tvshows/display-results.php?id=b" class="letters"><span class="B">B</span></a></li>
        <li><a href="tvshows/display-results.php?id=c" class="letters"><span class="C">C</span></a></li>
        <li><a href="tvshows/display-results.php?id=d" class="letters"><span class="D">D</span></a></li>
        <li><a href="tvshows/display-results.php?id=e" class="letters"><span class="E">E</span></a></li>
        <li><a href="tvshows/display-results.php?id=f" class="letters"><span class="F">F</span></a></li>
        <li><a href="tvshows/display-results.php?id=g" class="letters"><span class="G">G</span></a></li>
        <li><a href="tvshows/display-results.php?id=h" class="letters"><span class="H">H</span></a></li>
        <li><a href="tvshows/display-results.php?id=i" class="letters"><span class="I">I</span></a></li>
        <li><a href="tvshows/display-results.php?id=j" class="letters"><span class="J">J</span></a></li>
        <li><a href="tvshows/display-results.php?id=k" class="letters"><span class="K">K</span></a></li>
        <li><a href="tvshows/display-results.php?id=l" class="letters"><span class="L">L</span></a></li>
        <li><a href="tvshows/display-results.php?id=m" class="letters"><span class="M">M</span></a></li>
        <li><a href="tvshows/display-results.php?id=n" class="letters"><span class="N">N</span></a></li>
        <br></br>
        <li><a href="tvshows/display-results.php?id=o" class="letters"><span class="O">O</span></a></li>
        <li><a href="tvshows/display-results.php?id=p" class="letters"><span class="P">P</span></a></li>
        <li><a href="tvshows/display-results.php?id=q" class="letters"><span class="Q">Q</span></a></li>
        <li><a href="tvshows/display-results.php?id=r" class="letters"><span class="R">R</span></a></li>
        <li><a href="tvshows/display-results.php?id=s" class="letters"><span class="S">S</span></a></li>
        <li><a href="tvshows/display-results.php?id=t" class="letters"><span class="T">T</span></a></li>
        <li><a href="tvshows/display-results.php?id=u" class="letters"><span class="U">U</span></a></li>
        <li><a href="tvshows/display-results.php?id=v" class="letters"><span class="V">V</span></a></li>
        <li><a href="tvshows/display-results.php?id=w" class="letters"><span class="W">W</span></a></li>
        <li><a href="tvshows/display-results.php?id=x" class="letters"><span class="X">X</span></a></li>
        <li><a href="tvshows/display-results.php?id=y" class="letters"><span class="Y">Y</span></a></li>
        <li><a href="tvshows/display-results.php?id=z" class="letters"><span class="Z">Z</span></a></li>
      </ul>
    </div>
    ...
    <div class="mainAlphabetBottom">
      ...
      foreach ($result as $row) {
        echo '<td><a href="viewpage-show.php?id=' . $row['idShow'] . '"><img src="../src/thumbnails/' . $row['cachedurl'] . '" alt="' . $row['c00'] . '" height="240" width="160"/></a></td>';
      }
      echo "</tr>";
      echo "</table>";
      ?>
