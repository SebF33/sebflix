...
<?php
// Appeler les données des médias dont le titre commence par "1"
$query = $db->prepare(
  "SELECT *
    FROM tvshow
...
<head>
  <title>Séries en '0-9'</title>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="Description" content="Séries par chiffre">
